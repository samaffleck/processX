...
namespace px {
  ...
  TEST(ProcessX, SimpleSetup) {
    ...
    run_case("Unknowns: F_out, Cv (Fin, Pin, Pout fixed)", [](Valve& v, Stream& in, Stream& out){
    ...
    run_case("Unknowns: P_out, F_out (Fin, Pin, Cv fixed)", [](Valve& v, Stream& in, Stream& out){
    ...
    run_case("Unknowns: P_in, Cv (F fixed, P_out fixed)", [](Valve& v, Stream& in, Stream& out){
