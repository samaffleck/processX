...
# Step 1: Ask LLM what changes to make (structured format)
...
CHANGE|stream-1|molar flowrate|0.5
...
with open("final_gpt_test_modified.json", "w") as f:
    json.dump(edited_data, f, indent=2)
print("✓ Modified JSON saved as final_gpt_test_modified.json")
